...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: OrientationBuilder(builder: (context, orientation) {
        //uygulamayı tablette falan açarken ters çevirincee ayarlıyor
        if (orientation == Orientation.portrait) {
          return uygulamaGovdesi(); //dikeyse bu çalışsın değilse
        } else {
          return uygulamaGovdesiLandscpe(); //yataysa burası çalışacak (landscape)
        }
      }),
    );
  }
                ...
                child: RichText(
                  ...
                  text: TextSpan(
                    children: [
                      ...
                      //toStringAsFixed() dersek virgülden sonra kaç basamak istediğimizi belirtebiliriz.
                    ],
                  ),
                ),
              )),
  ...
  Widget uygulamaGovdesiLandscpe() {
    //yatay modda çalıştırmak için yazdık.İki parçaya böldük. Burası ilk paça.
    return Container(
        child: Row(
      ...
      children: [
        ...
        Expanded(
          //ikinci parça burası. ders ekleme kısmı.
          child: Container(
            child: ListView.builder(
              itemBuilder: _listeElemanlariniOlustur,
              itemCount: tumDersler.length,
  ...
  Widget _listeElemanlariniOlustur(BuildContext context, int index) {
    sayac++;
    debugPrint(sayac.toString()); //ekranda görmek için yazdık(kod ekranı)
    //Color olusanRastgeleRenk= rastgeleRenkOlustur();
    return Dismissible(
      key: Key(sayac.toString()),
      //key degerini vermezsek hata alırız. key, null olmamalı.
      direction: DismissDirection.startToEnd,
      onDismissed: (direction) {
        setState(() {
          tumDersler.removeAt(index);
          ortalamayiHesapla(); //tekrar çağırdık ki silindikten sonra tekrar hesaplasın ortalamayı
        });
      },
      child: Container(
        decoration: BoxDecoration(
